...
<body>
    ...
    echo "<br>";
    # gives the index value of the given letter
    echo strpos($string, "o");

    echo "<br>";
    # in this case it looks for the first instance the "Wo" is written and returns it's index value
    ...
    echo "<br>";
    # In this case the -2 well tell the computer to stop at the second to last index, in this case 10
    echo substr($string, 2, -2);

    echo "<br>";
    # "Explodes" a string into arrays based on property given in the function, in this case " ". And print_r can display an arry as a string
    ...
    # returns a int that corresponds with the amount of data in the array
    echo count($array);
    ...
    echo "<br>";
    # reverses so that the last piece of data is moved to index 0, and the second to last index 1
